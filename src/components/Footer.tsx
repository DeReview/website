...
const Footer: React.FC = () => {
  const navigation = {
    ...
    social: [
      {
        name: 'Twitter', href: 'https://twitter.com/DeReviewOrg', icon: (props: any) => (
      ...
      {
        name: 'GitHub', href: 'https://github.com/dereview', icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      { name: 'Discord', href: 'https://discord.gg/dereview', icon: ChatBubbleLeftRightIcon },
      {
        name: 'Telegram', href: 'https://t.me/dereview', icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand Section */}
          <div>
            <img src="/assets/logo-white.jpg" alt="DeReview" className="h-16 w-auto mb-6" />
